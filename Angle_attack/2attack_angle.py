...
def main():
    ...
    if dataset == 'ntu':
        ...
        train_data_path = '/usr/not-backed-up/dyf/code/data/ntu/val_data.npy'
        train_label_path = '/usr/not-backed-up/dyf/code/data/ntu/val_label.pkl'
        val_data_path = '/usr/not-backed-up/dyf/code/data/ntu/val_data.npy'
        val_label_path = '/usr/not-backed-up/dyf/code/data/ntu/val_label.pkl'
    if dataset == 'hdm05':
    ...
    if dataset == 'mhad':
        ...
        train_data_path = '/usr/not-backed-up/dyf/code/data/mhad/val_data.npy'
        train_label_path = '/usr/not-backed-up/dyf/code/data/mhad/val_label.pkl'
    ...
    for target_sample_data_old, target_label_old in Target_data:
        ...
        target_sample_ik,target_sample_euler = kinematics.target_ik(targets_sample_postprocessing,translate=False)
        ...
        for initial_sample_data_old, initial_label_old in Initial_data:
            ...
            while True:
                ...
                if diff_post <= 2e-2 or e_step > 500:
                    ad = True
                    '''''
                ...
                if ad == True:
                    ...
                    diff_ik1 = np.mean(tools.get_diff_np(adversarial_sample_postprocess2[:,1:,:], tar_postprocess))
                    ...
                    diff_ik2 = np.mean(tools.get_diff_np(ik_ad_sample_process,
                                                        tar_postprocess))
                    '''''
                    ...
                    diffes_ik_post.append(deepcopy(diff_ik2))
                    n_calls_list.append(deepcopy(n_calls))
                    n_steps_list.append(deepcopy(n_steps))
                    break
    ...
    path_save = '/usr/not-backed-up/dyf/code/black-box-attack/data/trial_hdm05/root0/'
    ...
    target_samples_process = tools.postprocessing_from_matlab(target_samples_matlab)
    adversarial_samples_matlab_ik = tools.postmatlab_one(adversarial_samples_matlab_ik, dataset)
    ad_samples_ik_process = tools.postprocessing_from_matlab(adversarial_samples_matlab_ik)
    np.save(os.path.join(path_save, 'target_samples_process.npy'), target_samples_process)
    np.save(os.path.join(path_save, 'ad_samples_ik_process.npy'), ad_samples_ik_process)
